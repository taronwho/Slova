...
RODINY: list[dict] = [
    ...
    dict(id="v11-lihovar", level="hard",
    ...
    dict(id="v11-cukrarna", level="normal",
    ...
    # ============================================== prameny názvů (10) =====
    dict(id="v11-vancura", level="hard",
    ...
    dict(id="v11-kastner", level="normal",
    ...
    dict(id="v11-twain", level="normal",
    ...
    dict(id="v11-kipling", level="hard",
    ...
    dict(id="v11-polacek", level="hard",
    ...
    dict(id="v11-chytilova", level="hard",
         ...
         inside=s("sedmikrásky ovoce stromy panelstory kalamita faunovo"
                  " pasti")),
    dict(id="v11-kubrick", level="hard",
    ...
    dict(id="v11-balety", level="normal",
