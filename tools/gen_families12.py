...
from gen_families10 import SLOVNIK, fold, priklonka, s  # noqa: E402
...
RODINY: list[dict] = [
    ...
    # ================================================ řemesla a obory (25) ==
    dict(id="v12-kominictvi", level="hard",
    ...
    dict(id="v12-kriminalistika", level="hard",
         ...
         avoid=s("pinzeta")),
    dict(id="v12-psychologie", level="normal",
    ...
    # ============================================== prameny názvů (10) =====
    dict(id="v12-hemingway", level="hard",
    ...
    dict(id="v12-skvorecky", level="hard",
    ...
    dict(id="v12-kachyna", level="hard",
    ...
    dict(id="v12-troska", level="normal",
    ...
    dict(id="v12-tucny", level="hard",
         ...
         inside=s("báječná ženská blbec sněhu kamarád rodeo halelujá"
                  " zlatokop")),
    dict(id="v12-trampske", level="normal",
    ...
    dict(id="v12-symfonicke-basne", level="hard",
    ...
    dict(id="v12-operety", level="hard",
    ...
    dict(id="v12-caj", level="normal",
         ...
         inside=s("zelený černý bílý rooibos oolong maté matcha jasmínový"),
         avoid=s("máta")),
    ...
    dict(id="v12-olympijska-mesta", level="hard",
         ...
         inside=s("Atlanta Sydney Barcelona Helsinky Antverpy Melbourne"
                  " Mnichov Soul"),
         avoid_asks=["jsou to zároveň jména českých měst"]),
    dict(id="v12-jazyky", level="normal",
         roof="názvy jazyků",
         ask="jsou to zároveň názvy jazyků",
         inside=s("baskičtina velština gruzínština sanskrt jidiš svahilština"
                  " urdština tamilština")),
