...
RODINY: list[dict] = [
    ...
    dict(id="v9-telocvik", level="normal",
    ...
    dict(id="v9-fyzika", level="hard",
         ...
         avoid=s("metr")),
    dict(id="v9-matematika", level="normal",
         ...
         avoid=s("matice")),
    dict(id="v9-kadernictvi", level="normal",
    ...
    dict(id="v9-myslivost", level="hard",
    ...
    dict(id="v9-letadlo", level="normal",
    ...
    dict(id="v9-mapa", level="hard",
         ...
         avoid=s("metr")),
    dict(id="v9-cirkus", level="normal",
    ...
    dict(id="v9-zahrada", level="normal",
    ...
    dict(id="v9-horolezectvi", level="hard",
    ...
    dict(id="v9-hrncirstvi", level="normal",
    ...
    dict(id="v9-lekarstvi", level="hard",
    ...
    dict(id="v9-posta", level="normal",
         ...
         avoid=s("schránka")),
    dict(id="v9-pocasi-pojmy", level="hard",
    ...
    dict(id="v9-chemie", level="normal",
    ...
    dict(id="v9-biologie", level="hard",
    ...
    dict(id="v9-armada", level="normal",
    ...
    dict(id="v9-knihovna", level="hard",
    ...
    dict(id="v9-hokej-pojmy", level="normal",
    ...
    dict(id="v9-atletika", level="normal",
    ...
    dict(id="v9-hodinarstvi", level="hard",
         ...
         avoid=s("hodinky")),
    dict(id="v9-pleteni", level="normal",
    ...
    dict(id="v9-televize", level="normal",
    ...
    dict(id="v9-pekarna", level="normal",
    ...
    # ================================================= další prameny názvů ==
    dict(id="v9-maly-princ", level="normal",
         ...
         avoid=s("zahrada")),
    dict(id="v9-alenka", level="normal",
    ...
    dict(id="v9-ostrov-pokladu", level="normal",
    ...
    dict(id="v9-christie", level="hard",
    ...
    dict(id="v9-sverak-uhlir", level="normal",
    ...
    dict(id="v9-kapely-pisne", level="normal",
