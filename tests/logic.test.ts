...
describe('souboje', () => {
  ...
  it('bilance se posune právě o jeden zápas', () => {
    const start = { nick: 'já', wins: 2, losses: 1, draws: 0, matches: [], blocked: [], log: [], sledovani: [], cekajici: [] }
  ...
  it('vyřízený zápas ze seznamu zmizí a nový se přidá jen jednou', () => {
    const start = { nick: 'já', wins: 0, losses: 0, draws: 0, matches: [], blocked: [], log: [], sledovani: [], cekajici: [] }
